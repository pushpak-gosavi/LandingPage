package com.pushpak_gosavi.pushpak.utils
...
object Constants {
    ...
    val MEDIUM_WEBSITE="https://medium.com/@pushpak.gosavi7"
    val LEETCODE_WEBSITE= "https://leetcode.com/pushpak_gosavi/"
    val LOREM_IPSUM =
    ...
    val PUSHPAK_GOSAVI= "I have 5+ years of work experience in Mobile Application Technology. I have worked on more than 10 mobile apps and have developed 5 of my own. They are available on Google Play Store across 172 countries."
    ...
    val FLUTTER_SERVIC="I am developing the hybrid mobile application using the Flutter technology. Flutter is an open-source UI software development kit created by Google. It is used to develop cross platform applications from a single codebase for any web browser, Fuchsia, Android, iOS, Linux, macOS, and Windows."
    val WEB_SERVICE="I am Developing the web applications using the KobWeb (Kotlin Web). Kobweb is an opinionated framework built on top of Compose for Web. It includes everything you need to build rich, dynamic websites, as well as web applications, while being able to leverage the greater Kotlin ecosystem."
    val ADOBEXD_SERVICE= "I am designing the prototype of applications using the Adone XD. Adobe XD is a vector design tool for web and mobile applications, developed and published by Adobe Inc."
...
object Res {
    object Icon {
        ...
        const val adobeXD = "adobe_xd.svg"
